...
@Component({
  selector: 'app-lis-income',
  templateUrl: './lis-income.component.html',
  styleUrls: ['./lis-income.component.css']
})
export class LisIncomeComponent implements OnInit {
  ...
  constructor(  private incomServic:IcomeService,private dailog:MatDialog,
    ...
    public dialogRef: MatDialogRef<ExitpermitFormComponent>) { }
  ...
  this.dailog.open(ExipermitsaveformComponent,dialogConfig);
  this.onClose();
  }
  onClose() {
